"""Full-text retrieval orchestrator: oa_url → PMC → Unpaywall → fallback."""
...
from src.clients import pdf, pmc, unpaywall
from src.models import ResolvedSource

logger: structlog.BoundLogger = structlog.get_logger(__name__)

FulltextMethod = Literal["oa_url_pdf", "pmc", "unpaywall_pdf", "abstract_fallback"]
...
def fetch_fulltext(
    ...
    *,
    ...
    Order, stopping at first success:
        ...
        3. source.doi    → unpaywall.get_oa_url → pdf.download_and_extract
        4. abstract_fallback (None)
