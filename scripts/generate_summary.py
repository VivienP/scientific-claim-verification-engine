...
TOOLS = [
    ...
    ("elicit_psilocybin", "Elicit Report mode (psilocybin / TRD)"),
    ("elicit_glp1_mace", "Elicit Systematic Review (GLP-1 / MACE)"),
    ("elicit_io_nsclc_gaps", "Elicit Systematic Review (PD-1 NSCLC gaps)"),
]
...
Pipeline: full-text verification (BM25 token-aware passage selection) + deterministic numeric checks (OR/CI + p-value/CI).
...
def update_readme(table: str) -> None:
    ...
    new_section = (
        ...
        "Committed reports under `benchmarks/real_outputs/` currently cover six\n"
